/**
 * Step 6: Problème à résoudre (optional)
 */
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.stepIndicator}>6/10</Text>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <Text style={styles.optional}>({t('onboarding.step6.optional')})</Text>
          <Text style={styles.subtitle}>{t('onboarding.step6.subtitle')}</Text>

          <TextInputField
            label=""
            value={watch('probleme')}
            onChangeText={(text) => setValue('probleme', text)}
