...
/**
 * StoreQuestionnaireSessionRequest
 * 
 * Validation légère pour la création de session anonyme.
 * Accepte payload partiel (même juste email).
 */
class StoreQuestionnaireSessionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            // Validation légère des types uniquement pour les champs présents
