...
class UpdateQuestionnaireSessionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payload.height_cm' => 'nullable|numeric|between:50,250',
            ...
            'payload.running_experience_period' => 'nullable|in:je_commence,je_reprends,1_4_semaines,1_11_mois,1_10_ans,plus_10_ans',
            'payload.running_experience_weeks' => 'nullable|string|max:10',
            'payload.running_experience_months' => 'nullable|string|max:10',
            'payload.running_experience_years' => 'nullable|string|max:10',
            'payload.pause_duration' => 'nullable|string|max:20',
            'payload.records' => 'nullable|string|max:1000',
            'payload.objectives' => 'nullable|string|max:1000',
            'payload.race_distance_other' => 'nullable|string|max:255',
            'payload.other_training_location' => 'nullable|string|max:255',
